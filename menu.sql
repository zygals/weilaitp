...
CREATE TABLE `menu_admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='后台左侧导航';
...
INSERT INTO `menu_admin` VALUES (19,'主要管理',0,'','','',0,1505358580,1505358580),(20,'资讯',19,'Article','index','',0,1505358628,1505358628),(21,'案例',19,'Anli','index','',1,1505358670,1505358670),(22,'广告图',19,'Ad','index','',4,1505358704,1505375295),(23,'其它管理',0,'','','',1,1505358751,1505358751),(24,'招贤纳士',23,'Recruit','index','',3,1505358773,1505465541),(25,'改密码',23,'Admin','edit','',4,1505358851,1505465566),(26,'案例类别',23,'CateAnli','index','',0,1505369468,1505465510),(27,'案例功能',23,'Func','index','',1,1505375321,1505465516),(28,'合作/友情链接',23,'friend','index','',2,1505438054,1505465577);
...
-- Dump completed on 2017-09-18  9:13:13

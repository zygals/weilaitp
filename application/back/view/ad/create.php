...
<?php }?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4 ">
                                <input type="file" title='' class="form-control  duiqi" id="sOrd" name="img" placeholder=""><span style="color:red">尺寸要求（<b id="pix_require">1290*670</b>），大小不超过<?php echo floor(config('upload_size')/1024/1024);?>M。</span>
                            </div>

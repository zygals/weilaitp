...
CREATE TABLE `admin_log` (
  ...
  `update_time` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='后台管理员登录日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='anli';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `article` (
  ...
  PRIMARY KEY (`id`),
  KEY `cate` (`cate`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='资讯表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-09-15 17:44:51
